...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\marga\PycharmProjects\MA-test-task\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\marga\PycharmProjects\MA-test-task\venv\Scripts\deactivate.nu'
